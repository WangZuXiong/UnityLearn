...
public class GameUIBehaviour : MonoBehaviour
{
    ...
    public void Show()
    {
        ...
        builder.Append(string.Format("Team 的总体能：{0}\n", GameData.Config.TeamEnergy.ToString()));
        ...
        builder.Append(string.Format("Main City 被攻击的CD：{0}s\n", GameData.Config.MainCityAttackCD.ToString()));
